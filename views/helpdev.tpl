<div class="container">
    ...
    <div class="span10" id="glossary-content">
      ...
      <div class='section'>
        ...
        <div class='section'>
          <p>
          Для сборки привязок библиотеки к языку Python используется генератор интерфейсов SWIG. Он позволяет по описаниям функций C++ в заголовочных файлах постороить функции, вызывающие функции библиотеки, выполняя необходимые преобразования данных из типов данных python в типы данных библиотеки и обратно. Поведение SWIG при сборке описывается в файле <code>AAL.i</code>. Ниже приведен фрагмент, ползоляющий привести разложения чисел из <code>std::vector&lt;AAL::DecompositionMember&gt;</code> к списку кортежей вида <code>(множитель, степень)</code>:
          </p>
          <div class='section'>
            <pre>
