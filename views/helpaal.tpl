...
red 1 .</code></pre>
      ...
      <p>Pandas - библиотека python для обработки и анализа данных. <a
        ...
        доступны через стандартные префиксы: <code>pd</code>, что эквивалентно <code>pandas</code>. </p>
      ...
      <p>Matplotlib - библиотека python для визуализации данных. <a
        ...
        доступны через стандартные префиксы: <code>plt</code>, что эквивалентно <code>matplotlib.pyplot</code>.
      </p>
...
plt.clf()</pre>
      ...
      <p>Seaborn - ещё одна библиотека python для визуализации данных. <a
        ...
        доступны через стандартные префиксы: <code>sns</code>, что эквивалентно <code>seaborn</code>.
      </p>
