    ...
    <div class="span7">
      ...
      <div class="row-fluid">
        ...
        <a href="#" style="font-size: 13px;" rel="tooltip" data-placement="bottom"
          data-original-title="Выполнить выделенное. Можно выделить несколько регионов, зажав Ctrl" class="btn span4"
          onclick="return run(get_sel());"><i class="icon-resize-vertical"></i> Продолжить</a>
        <a href="#" style="font-size: 13px;" rel="tooltip" data-placement="bottom"
          data-original-title="Проверить значение выделенной переменной или выражения" class="btn btn-info span4"
          onclick="return run(get_sel(),'console');"><i class="icon-eye-open icon-white"></i><span>
            Инспектировать</span></a>
      </div>
    </div>
    <div class="span5">
